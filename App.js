...
// pegar o tamanho total da tela 
const {width:screenWidth,height:scrennHeight} = Dimensions.get("window")
...
export default function App() {
  ...
  return (
   <ScrollView style={styles.container}>
     <View style={{flex:1,height:scrennHeight}}>
        ...
        <ImageBackground
          ...
          marginLeft:10,marginVertical:10}}
            ...
            <View style={styles.moreInfo}>
              ...
              <Text style={styles.movieText}>{lista[activeIndex].text}</Text>
              </View>
